...
export const Text: FC<TextProps> = ({color = 'neutral-0', size = 'M', weight = 'normal', className, onClick, children}) => {
  return (
    <StyledSpan textSize={size} textColor={color} textWeight={weight} className={className} onClick={onClick}>
      {children}
    </StyledSpan>
  )
}
